...
class _$UsersResponseImpl extends _UsersResponse {
  ...
  @override
  String toString() {
    return 'UsersResponse(users: $users, total: $total, skip: $skip, limit: $limit)';
  }
...
abstract class _UsersResponse extends UsersResponse {
  factory _UsersResponse(
      ...
      required final int limit}) = _$UsersResponseImpl;
  _UsersResponse._() : super._();
...
class _$UserImpl extends _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, firstName: $firstName, lastName: $lastName, email: $email, image: $image, username: $username, password: $password, token: $token)';
  }
...
class _$AuthUserImpl extends _AuthUser {
  ...
  @override
  String toString() {
    return 'AuthUser(id: $id, firstName: $firstName, lastName: $lastName, email: $email, image: $image, username: $username, token: $token)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, firstName, lastName, email, image, username, token);
...
/// @nodoc
@JsonSerializable()
class _$ProductsResponseImpl extends _ProductsResponse {
...
abstract class $CartsResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Cart> carts, int total, int skip, int limit});
}
...
/// @nodoc
@JsonSerializable()
class _$CartsResponseImpl extends _CartsResponse {
  _$CartsResponseImpl(
  ...
  @override
  String toString() {
    return 'CartsResponse(carts: $carts, total: $total, skip: $skip, limit: $limit)';
  }
...
abstract class _CartsResponse extends CartsResponse {
  factory _CartsResponse(
      {required final List<Cart> carts,
      required final int total,
      required final int skip,
      required final int limit}) = _$CartsResponseImpl;
  _CartsResponse._() : super._();
...
class _$CartImpl extends _Cart {
  ...
  @override
  String toString() {
    return 'Cart(id: $id, total: $total, discountedTotal: $discountedTotal, totalProducts: $totalProducts, totalQuantity: $totalQuantity, products: $products)';
  }
